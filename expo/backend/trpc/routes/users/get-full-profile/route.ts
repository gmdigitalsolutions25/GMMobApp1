    ...
    try {
      ...
      return {
        user: {
          ...
          theme: user.theme,
          monthlyMileage: user.monthlyMileage ?? undefined,
          lastServiceDate: user.lastServiceDate ?? undefined,
          preferredServiceCenter: user.preferredServiceCenter ?? undefined,
